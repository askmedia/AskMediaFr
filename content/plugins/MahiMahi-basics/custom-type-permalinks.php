<?php
/*
Plugin Name: Mahi Custom Post Type Permalinks
...
class Custom_Post_Type_Permalinks {
	...
	public function setting_section_callback_function() {
		?>
			...
			<?php _e("The tags you can use is WordPress Structure Tags and '%tax-\"custom_taxonomy_slug\"%'. (e.g. %tax-actors%)",'cptp');?><br />
			<?php _e("%tax-\"custom_taxonomy_slug\"% is replaced the taxonomy's term.'.",'cptp');?></p>
